<?php
    ...
    class RedisController extends Controller
    {
		...
		public function search_data(){
			...
			$start_time = strtotime('2019-10-03 00:00:00');
			//echo $start_time;die;
			//$end_time = strtotime(date("Y-m-d"),time());
			$end_time = strtotime('2019-10-04 00:00:00');
			//今日借款
			...
			if(!empty($reg_list)){
				...
				echo date('Y-m-d',$start_time)."借款标的".$data_reg."<br>";
			}else{
				echo date('Y-m-d',$start_time)."无借款标的"."<br>";
			}
			//今日还款
			...
			if(!empty($repay_list)){
				...
				echo date('Y-m-d',$start_time)."还款标的".$data_repay;
			}else{
				echo date('Y-m-d',$start_time)."无还款标的";
			}
