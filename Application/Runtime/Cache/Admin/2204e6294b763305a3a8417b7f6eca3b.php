...
<body>
<form class="cmxform" id="signupForm" method="post" action="<?php echo U('User/add');?>">
  <table class="tb_add">
	<tr>
	...
	<tr>
		<td colspan=2 align="center"><input class="submit" type="submit" name="submit" value="提交"></td>
	</tr>
